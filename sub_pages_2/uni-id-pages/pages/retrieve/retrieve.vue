	...
	<view class="uni-content">
		...
		<uni-forms ref="form" :value="formData" err-show-type="toast">
			...
			<uni-forms-item name="code">
				<uni-id-pages-sms-form ref="shortCode" :phone="formData.phone" type="reset-pwd-by-sms" v-model="formData.code"></uni-id-pages-sms-form>
			</uni-forms-item>
	...
	methods: {
		...
		submit() {
			...
			this.$refs.form
				.validate()
				.then(res => {
					let { phone: mobile, password: password, captcha, code } = this.formData;
					uniIdCo
						.resetPwdBySms({
							mobile,
							code,
